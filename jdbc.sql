...
SELECT ENROLL_DATE, MEMBER_ID, MEMBER_NM, MEMBER_GENDER
FROM "MEMBER"
...
INSERT INTO BOARD 
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 1', '샘플 내용 1입니다.', 
		TO_DATE('2022-09-21 10:30:12', 'YYYY-MM-DD HH24:MI:SS'),
		DEFAULT, DEFAULT, 3);

INSERT INTO BOARD 
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 2', '샘플 내용 2입니다.', 
		TO_DATE('2022-09-21 20:17:12', 'YYYY-MM-DD HH24:MI:SS'),
		DEFAULT, DEFAULT, 3);

INSERT INTO BOARD 
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 3', '샘플 내용 3입니다.', 
		DEFAULT,DEFAULT, DEFAULT, 3);

INSERT INTO BOARD 
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 4', '샘플 내용 4입니다.', 
		DEFAULT,DEFAULT, DEFAULT, 3);
SELECT * FROM "BOARD";
...
COMMENT ON COLUMN "COMMENT".MEMBER_NO IS '댓글 작성자 회원번호';
COMMENT ON COLUMN "COMMENT".BOARD_NO IS '댓글이 작성된 게시글 번호';


--- 게시글 목록 상세 조회(댓글 수 포함 -> 상관커리)
...
-- 1분  == 1/ 24/60
-- 1초  == 1/ 24/ 60/ 60
SELECT FLOOR(( SYSDATE - TO_DATE('2022-09-22') ) * 24 * 60)  FROM DUAL;
...
-- 내용
-- AND BOARD_CONTENT LIKKE '%'||?||'%'
-- 제목 + 내용
-- AND (BOARD_TITLE LIKE '%'||?||'%'
-- OR BOARD_CONTENT LIKKE '%'||?||'%')
-- 작성자
-- AND MEMBER_NM LIKE '%'||?||'%'
ORDER BY BOARD_NO DESC;