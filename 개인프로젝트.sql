...
FROM PLAYER
WHERE PLAYER_NO = 4
AND PLAYER_PASSWORD = 'p4'
AND PLAYER_TEAM = 'NY'


ALTER TABLE PITCHER ADD PLA_TEAM VARCHAR2(10) DEFAULT 'NY';
ALTER TABLE HITTER ADD PLA_TEAM VARCHAR2(10) DEFAULT 'NY';

ALTER TABLE HITTER DROP (PLA_TEAM);

UPDATE PLAYER SET PLAYER_TEAM = 'LAD'
WHERE PLAYER_NO = 1

UPDATE PITCHER SET PLAYER_TEAM = 'LAD'
WHERE PLAYER_NO = 1;

UPDATE PITCHER SET PLAYER_TEAM = 
WHERE PLAYER_NO = ? 


UPDATE PLAYER AS p, HITTER AS s
      SET  p.PLAYER_TEAM = 'LAD',
              s.PLA_TEAM = 'LAD'
﻿ WHERE  p.PLAYER_NO = 1
      AND  s.PLAYER_NO = 1