...
ADD CONSTRAINT DEPT_COPY_TITLE_UNI UNIQUE(DEPT_TITLE);


-- DEPT_COPY의 DEPT_TITLE 컬럼에 UNIQUE 삭제
ALTER TABLE DEPT_COPY
DROP CONSTRAINT DEPT_COPY_TITLE_UNI;
...
-- ORA-12899: "KH_YHJ"."DEPT_COPY"."DEPT_ID" 열에 대한 값이 너무 큼(실제: 3, 최대값: 2)
...
-- DEPT_COPY 테이블에 PK 추가(DEPT_ID 컬럼에 D_COPY_PK)
